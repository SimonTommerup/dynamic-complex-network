...
DATA_PATH = "hospital-proximity.npy"
...
# lfname = f"hospital-bs146-gc30-rs=1-nps=73" + ".pth"
...
init_beta=0.0
lfpath = r"state_dicts/training_experiment"
lfname = f"hospital-bs146-gc30-rs=1-nps=73-train-all-scheduled" + ".pth"
