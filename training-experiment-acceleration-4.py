...
# load_fname = f"synthetic-150-bs=139-nps=695-gc=30-train-all-nodespecificbeta" + ".pth"
...
model, train_loss, test_loss= smallnet.batch_train_scheduled(model, n_train, training_data, training_batches, test_data, num_epochs)


save_fname = f"synthetic-150-bs=139-nps=695-gc=30-train-all-nodespecificbeta" + ".pth"
